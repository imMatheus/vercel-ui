...
import { Menu, MenuButton, MenuContainer, MenuItem } from "./ui/dropdown-menu"
...
export function ModeToggle() {
  ...
  return (
    <MenuContainer>
      ...
      <Menu align="end">
        <MenuItem onClick={() => setTheme(Theme.LIGHT)}>Light</MenuItem>
        <MenuItem onClick={() => setTheme(Theme.DARK)}>Dark</MenuItem>
      </Menu>
    </MenuContainer>
  )
}
